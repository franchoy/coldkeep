...
| CK-112-R003 | Catalog facade may accidentally become SQLite-specific | S1 | catalog/db | Phase 4 | open | Phase 3 introduced real wrappers using `$1` positional placeholders (backend-neutral). Backend contract tests for SQLite+PostgreSQL parity are Phase 4 work. |
