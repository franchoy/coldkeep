...
require_pattern "$MATRIX_FILE" '^| G14 |' 'G14: snapshot-retained content GC safety row'
require_pattern "$MATRIX_FILE" '^| G15 |' 'G15: snapshot deletion metadata-only semantics row'
require_pattern "$MATRIX_FILE" '^| G16 |' 'G16: snapshot-retention observability row'
require_pattern "$MATRIX_FILE" '^| G17 |' 'G17: snapshot reachability integrity audit row'
